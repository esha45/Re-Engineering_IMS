...
if(isset($_POST) AND count($_POST) > 0){
    ...
    $Product_Cateogory = $_POST['Product_Category'];
	$Product_Description = htmlentities($_POST['Product_Description']);
	$Product_Status = $_POST['Product_Status'];

	$sql = "INSERT INTO products (Product_Name,Product_Price,Product_Category,Product_Description,Product_Status) VALUES ('".$Product_Name."','".$Product_Price."','".$Product_Cateogory."','".$Product_Description."','".$Product_Status."')";
				...
				?>
	  			...
	  			<form action="productManagement.php" method="POST">
				  	...
				  	<div class="form-group">
				    	...
				    	<input type="text" name="Product_Price" required class="form-control" placeholder="Product Price">
				  	</div>

                      <div class="form-group">
				    	<label for="email">Product Category:</label>
				    	<input type="text" name="Product_Category" required class="form-control" placeholder="Product Category">
				  	</div>


				  	<div class="form-group">
				    	<label for="email">Product Description:</label>
				    	<textarea name="Product_Description" required class="form-control" placeholder="Product Description"></textarea>
				  	</div>

				  	<div class="form-group">
                      <label for="examplestatus">Status</label><br>
                                        <select class="form-control" name="Product_Status" value="<?php echo $data['Product_Status'] ?>">
					    ...
					    if(mysqli_num_rows($product_result) > 0)
					    {
					        ...
					        ?>
						      <tr>
						        ...
						        <td>
						        	<a href="#" data-href="deleteProducts.php?Product_ID=<?php echo $row["Product_ID"];?>" class="btn btn-danger delete_this_item">Delete</a>
						        </td>
						      </tr>
						    <?php 
							}
