...
$product_sql ="SELECT * FROM categories";
  		...
  		<div class="row">
  			<div class="col-md-6">
				...
				?>
	  			...
	  			<form action="categoriesManagement.php" method="POST">
					    ...
					    if(mysqli_num_rows($product_result) > 0)
					    {
					        ...
					        ?>
						      <tr>
						        ...
						        <td>
						        	<a href="#" data-href="deleteCategories.php?Category_ID=<?php echo $row["Category_ID"];?>" class="btn btn-danger delete_this_item">Delete</a>
						        </td>
						      </tr>
						    <?php 
							}
